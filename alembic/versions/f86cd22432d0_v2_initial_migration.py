...
Revision ID: f86cd22432d0
Revises: 
Create Date: 2026-07-21 16:23:44.645384
...
def downgrade() -> None:
    ...
    sa.Column('direction', sa.VARCHAR(length=9), nullable=False),
    ...
    sa.Column('made_on', sa.DATETIME(), nullable=True),
    sa.Column('created_at', sa.DATETIME(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
