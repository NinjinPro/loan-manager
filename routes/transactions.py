...
def add_transaction():
    if request.method == "POST":
        ...
        direction = MoneyDirection(request.form["direction"])
        ...
        made_on_str = request.form.get("made_on")
        created_at_str = request.form.get("created_at")
        paid_date_str = request.form.get("paid_date")
        is_paid = request.form.get("is_paid") == "on"

        due_date = datetime.strptime(due_date_str, "%Y-%m-%d") if due_date_str else None
        made_on = datetime.strptime(made_on_str, "%Y-%m-%d") if made_on_str else None
        created_at = datetime.strptime(created_at_str, "%Y-%m-%dT%H:%M") if created_at_str else datetime.utcnow()
